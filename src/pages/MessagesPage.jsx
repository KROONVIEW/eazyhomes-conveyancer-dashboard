...
const MessagesPage = () => {
  ...
  return (
    <Layout>
      <div className="flex w-full min-h-[calc(100vh-0px)] bg-gray-50 overflow-auto justify-center items-center">
        <div className="max-w-[1440px] w-full h-[90vh] flex bg-white rounded-xl shadow-md overflow-hidden" style={{minHeight: 600}}>
          {/* Left Panel: Conversation List */}
          <div className="w-80 min-w-[18rem] max-w-xs h-full border-r border-gray-200 bg-white flex-shrink-0 overflow-y-auto">
            <ConversationList activeId={activeId} onSelect={setActiveId} />
          </div>
          {/* Right Panel: Chat Window */}
          <div className="flex-1 h-full min-w-0 flex flex-col">
            <ChatWindow chat={chatData[activeId]} />
          </div>
        </div>
      </div>
    </Layout>
