  ...
  return (
    <Layout>
      <div className="dashboard-main-content-area">
        <div className="dashboard-unified-header-row">
          <h1 className="dashboard-page-title">Dashboard</h1>
          <div className="flex-grow">
            <SearchBar />
          </div>
          <input type="text" className="date-picker-input" placeholder="yyyy/mm/dd" />
          <input type="text" className="date-picker-input" placeholder="yyyy/mm/dd" />
          <div className="header-icon-button ellipsis-icon relative">
            <HamburgerMenu triggerIcon={<FiMoreHorizontal className="w-6 h-6" />} />
          </div>
          <div className="header-icon-button notification-icon" onClick={() => setDrawerOpen(true)}>
            <FiBell />
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6'>
          ...
          <DashboardCard
            ...
            data-tooltip-content="Total active transfers being managed by your team, encompassing residential, commercial, and estate matters."
            data-tooltip-html="<div style='margin-bottom:6px;'>Total active transfers being managed by your team, encompassing residential, commercial, and estate matters.</div><a href='/matters' style='color:#6366f1;text-decoration:underline;font-size:0.95em;'>View Details</a>"
            className="hover:shadow-lg transition-shadow duration-200"
          >
            <div className="flex items-center justify-between mb-2">
              <div className='p-3 rounded-full bg-blue-50 text-blue-600'>
                <Icons.FiActivity className='w-6 h-6' data-tooltip-id="icon-tooltip" data-tooltip-content="This icon represents active transfers." />
              </div>
            </div>
          ...
          <DashboardCard
            ...
            data-tooltip-content="Total deals successfully completed this year, including transfers, leases, and bond cancellations."
            data-tooltip-html="<div style='margin-bottom:6px;'>Total deals successfully completed this year, including transfers, leases, and bond cancellations.</div><a href='/matters?filter=closed' style='color:#6366f1;text-decoration:underline;font-size:0.95em;'>View Details</a>"
            className="hover:shadow-lg transition-shadow duration-200"
          >
            <div className="flex items-center justify-between mb-2">
          ...
          <DashboardCard
            ...
            data-tooltip-content="Critical documents required for transfers to proceed: FICA verification, signed offers, and rates clearance."
            data-tooltip-html="<div style='margin-bottom:6px;'>Critical documents required for transfers to proceed: FICA verification, signed offers, and rates clearance.</div><a href='/matters?filter=docs' style='color:#6366f1;text-decoration:underline;font-size:0.95em;'>View Details</a>"
            className="hover:shadow-lg transition-shadow duration-200"
          >
            <div className="flex items-center justify-between mb-2">
          ...
          <DashboardCard
            ...
            data-tooltip-content="Transfers pending approval or action from financial institutions, such as bond grants or payment confirmations."
            data-tooltip-html="<div style='margin-bottom:6px;'>Transfers pending approval or action from financial institutions, such as bond grants or payment confirmations.</div><a href='/matters?filter=bank' style='color:#6366f1;text-decoration:underline;font-size:0.95em;'>View Details</a>"
            className="hover:shadow-lg transition-shadow duration-200"
          >
            <div className="flex items-center justify-between mb-2">
          ...
          {/* Insights Section (moved to bottom) */}
      ...
      {/* Global React Tooltip for all metric cards */}
      <Tooltip
      ...
      <Tooltip
        ...
        arrowColor="#fff"
      />
      {/* Add demo tooltips for new elements */}
      <Tooltip
        id="icon-tooltip"
        place="right"
        effect="solid"
